...
function optionsframework_options() {
	...
	$options[] = array(
		'name' => __( 'Limit Post to show on Front Page', 'theme-textdomain' ),
		'desc' => __( 'Limit Post', 'theme-textdomain' ),
	...
	$options[] = array(
		'name' => __( 'Posts to limit', 'theme-textdomain' ),
		'desc' => __( 'Posts.', 'theme-textdomain' ),
	...
	$options[] = array(
		'name' => __( 'Show Sidebar on Front Page', 'theme-textdomain' ),
		'desc' => __( 'Show Sidebar', 'theme-textdomain' ),
